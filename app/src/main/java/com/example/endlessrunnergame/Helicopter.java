...
public class Helicopter extends Sprite {
    ...
    public Helicopter(Resources res){
        ...
        directionY = 0;
        image = new Bitmap[4];
        image[0] = BitmapFactory.decodeResource(res, R.drawable.heli0);
        image[1] = BitmapFactory.decodeResource(res, R.drawable.heli1);
        image[2] = BitmapFactory.decodeResource(res, R.drawable.heli2);
        image[3] = BitmapFactory.decodeResource(res, R.drawable.heli3);
